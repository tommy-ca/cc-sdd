...
- Source of truth: `skills/kiro-validate-design/SKILL.md` (preferred) or `{{KIRO_DIR}}/skills/kiro-validate-design/SKILL.md` or `{{KIRO_DIR}}/plugins/kiro-sdd/skills/kiro-validate-design/SKILL.md`.
