...
- Source of truth: `skills/kiro-spec-requirements/SKILL.md` (preferred) or `{{KIRO_DIR}}/skills/kiro-spec-requirements/SKILL.md` or `{{KIRO_DIR}}/plugins/kiro-sdd/skills/kiro-spec-requirements/SKILL.md`.
