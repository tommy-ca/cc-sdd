...
- Source of truth: `skills/kiro-spec-impl/SKILL.md` (preferred) or `{{KIRO_DIR}}/skills/kiro-spec-impl/SKILL.md` or `{{KIRO_DIR}}/plugins/kiro-sdd/skills/kiro-spec-impl/SKILL.md`.
