...
- Source of truth: `skills/kiro-validate-impl/SKILL.md` (preferred) or `{{KIRO_DIR}}/skills/kiro-validate-impl/SKILL.md` or `{{KIRO_DIR}}/plugins/kiro-sdd/skills/kiro-validate-impl/SKILL.md`.
